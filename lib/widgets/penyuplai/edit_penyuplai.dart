                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            child: TextFormField(initialValue: widget.penyuplai.namaPenyuplai,
                          ...
                          Container(
                            margin: const EdgeInsets.only(bottom: 20),
                            child: TextFormField(initialValue: widget.penyuplai.nomorHp,
                                onChanged: (val) {
                                  noHp = val.toString();
                                },
                                maxLines: 1,
                          ...
                          Container(
                            margin: const EdgeInsets.only(bottom: 20),
                            child: TextFormField(initialValue: widget.penyuplai.alamat,
                                onChanged: (val) {
                                  alamat = val.toString();
                                },
                                maxLines: 3,
